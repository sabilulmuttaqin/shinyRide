            ...
            <div class="px-4 flex justify-between items-center transform translate-y-1/2 absolute bottom-0 z-10 w-full">
                ...
                @else
                    <div class="flex flex-col">
                        <p
                            class="badge w-fit rounded-full p-[6px_10px] bg-red-500 font-bold text-xs leading-[18px] text-white">
                            CLOSED</p>
                        <p class="badge w-fit rounded-full pt-[20px]  font-bold text-xs leading-[18px] text-black">
                            LOL</p>
                    </div>
                @endif
                <div class="flex items-center w-fit rounded-full border border-[#E9E8ED] p-[6px_12px] bg-white">
                    ...
                    <p class="text-sm leading-[21px] text-[#909DBF]"><span
                            class="font-semibold text-[#270738]">{{ $carStore->rating }}</span>
                        <span>(145,394)</span>
                    </p>
                </div>
            </div>
            ...
            <div class="relative p-4 px-9 w-full max-w-2xl max-h-full">
                ...
                <div class="bg-white max-w-[320px] mx-auto flex flex-col h-fit rounded-[20px] pb-4 gap-4 overflow-hidden">
                    ...
                    <div class="flex flex-col px-4 gap-4">
                        ...
                        <p class="leading-[28px]">Menggunakan metode golden touch maka pencucian mobil akan lebih cepat,
                            bersih, dan tidak mudah kotor kembali.</p>
