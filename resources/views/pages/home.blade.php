...
@section('content')
    <main
        class="bg-white max-w-[640px] mx-auto min-h-screen relative flex flex-col has-[#CTA-nav]:pb-[120px] has-[#Bottom-nav]:pb-[120px]">
            ...
            <section id="Services" class="flex flex-col gap-3 px-4">
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    @foreach ($services as $service)
                        <a href="#" class="card-services service-link" data-service="{{ $service->id }}">
                            <div
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <p class="text-xs leading-[18px] text-[#909DBF]">{{ $service->storeServices->count() }}
                                        Stores
                                    </p>
                                </div>
                            </div>
